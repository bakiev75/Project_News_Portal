...
urlpatterns = [
   ...
   # path('', cache_page(60*10)(NewsList.as_view()), name='news_list'),       # Для кэша - снять комментирование
   path('', NewsList.as_view(), name='news_list'),                            # и закомментировать эту строку
